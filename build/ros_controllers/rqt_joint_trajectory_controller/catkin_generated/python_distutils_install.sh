...
echo_and_run cd "/home/jiaid/ur5_rehab_ws/src/ros_controllers/rqt_joint_trajectory_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jiaid/ur5_rehab_ws/src/ros_controllers/rqt_joint_trajectory_controller/setup.py" \
    egg_info --egg-base /home/jiaid/ur5_rehab_ws/build/ros_controllers/rqt_joint_trajectory_controller \
    build --build-base "/home/jiaid/ur5_rehab_ws/build/ros_controllers/rqt_joint_trajectory_controller" \
    install \
    --root="${DESTDIR-/}" \
