...
echo_and_run cd "/home/jiaid/ur5_rehab_ws/src/ros_control/controller_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jiaid/ur5_rehab_ws/src/ros_control/controller_manager/setup.py" \
    egg_info --egg-base /home/jiaid/ur5_rehab_ws/build/ros_control/controller_manager \
    build --build-base "/home/jiaid/ur5_rehab_ws/build/ros_control/controller_manager" \
    install \
    --root="${DESTDIR-/}" \
