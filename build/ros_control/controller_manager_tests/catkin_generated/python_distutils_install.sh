...
echo_and_run cd "/home/jiaid/ur5_rehab_ws/src/ros_control/controller_manager_tests"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jiaid/ur5_rehab_ws/src/ros_control/controller_manager_tests/setup.py" \
    egg_info --egg-base /home/jiaid/ur5_rehab_ws/build/ros_control/controller_manager_tests \
    build --build-base "/home/jiaid/ur5_rehab_ws/build/ros_control/controller_manager_tests" \
    install \
    --root="${DESTDIR-/}" \
