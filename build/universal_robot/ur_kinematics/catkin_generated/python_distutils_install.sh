...
echo_and_run cd "/home/jiaid/ur5_rehab_ws/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jiaid/ur5_rehab_ws/src/universal_robot/ur_kinematics/setup.py" \
    egg_info --egg-base /home/jiaid/ur5_rehab_ws/build/universal_robot/ur_kinematics \
    build --build-base "/home/jiaid/ur5_rehab_ws/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
